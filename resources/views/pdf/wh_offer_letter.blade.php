...
<body>
    ...
    <main>
            ...
            <span style="font-size:11pt">
                <span style="font-family:Calibri,sans-serif">
                    <span lang="EN-IN" style="font-size:12.0pt">
                        <span style="font-family:&quot;Cambria&quot;,serif">You will be joining the company not later than {{$data->date_name}} {{$data->month}} {{$data->year}}.
                            {{-- , and your CTC will be of <span style="font-family: DejaVu Sans; sans-serif;"> &#8377;</span>{{$data->salary}} P/A. --}}
                        </span>
                    </span>
                </span>
            </span>
        ...
        <p class="MsoNoSpacing "><span style="font-size:11pt"><span style="font-family:Calibri,sans-serif"><span lang="EN-IN" style="font-size:12.0pt"><span style="font-family:&quot;Cambria&quot;,serif">For Dipto Diagnostic Pvt. Ltd.</span></span></span></span>



         <img src="{{asset('/stamp.png')}}" alt="" height="100px" width="100px" class="stamp">
