        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content card border-0">
                ...
                <div class="card-img-overlay text-center">
                    ...
                    <p class="fs-4 fw-bold text-dark align-middle text-success   text-center" style="    margin-top: 28px; margin-left: 28px;"><i class="fab fa-google-play"></i> Install Our App </p>
