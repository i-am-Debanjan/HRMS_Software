...
>
  <head>
   <meta charset="utf-8">
    ...
    <title id="ep_main_title">Dipto EP</title>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            ...
            <img src="../img/logo_dipto_r3_final.png" class="rounded-circle" height="40px" width="40px" alt="">
              ...
              <!-- Search -->
               <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  ...
                  <h4 class="mt-2 mb-2 d-none d-md-block"><i class="fas fa-sun"></i> Good Moring <b>Debanjan</b> ......</h4>
                </div>
              </div>
              <!-- /Search -->
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="../img/icon_title3.png" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Dipto</span>
